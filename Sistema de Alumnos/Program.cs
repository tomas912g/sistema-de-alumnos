...
Console.WriteLine($"El alumno {alumno1.Nombre} tiene un promedio de: {alumno1.Promedio()}");

Alumno alumno2 = new Alumno("Peira", 2, 8m, 7m);
Console.WriteLine($"El alumno {alumno2.Nombre} tiene un promedio de: {alumno2.Promedio()}");
